    ...
    for (i in 1:nof_categories) {
      ...
      if (system_instruments == TRUE){
        ...
        if(collapse==FALSE){
          ...
          if(lags==2) P2a <- matrix(P2a[,-1], nrow = nrow(P2a))


          if(lags>2) P2a <- matrix(P2a[,-(1:(lags-1))], nrow = nrow(P2a))
